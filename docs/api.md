...
```json
{
  "excerpt": "这是一段 AI 生成的文章摘要..."
}
```

**说明**: 
- 使用 AI 生成 50-150 字的文章摘要
- 若 AI 不可用，自动提取文章前 150 字
...
```json
[
  { "date": "2025-12-06", "views": 120, "visitors": 45 },
  { "date": "2025-12-05", "views": 98, "visitors": 32 }
]
```
